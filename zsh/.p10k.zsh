...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=129
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_BACKGROUND=1
  # Green prompt symbol if the last command succeeded.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=129
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=164
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=171
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=099
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=069
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=192
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=225
  typeset -g POWERLEVEL9K_VCS_FOREGROUND=092
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=129
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=213

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='✔'
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=129
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=213
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=205
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=205
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=205

  ###################[ command_execution_time: duration of the last command ]###################
  # Execution time color.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=255
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=099
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=213
  ...
  typeset -g POWERLEVEL9K_TIMEWARRIOR_BACKGROUND=213
  ...
  typeset -g POWERLEVEL9K_TOOLBOX_BACKGROUND=213
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=129
